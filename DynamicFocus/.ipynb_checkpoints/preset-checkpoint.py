...
# 定义所有的机器名称
PC_NAME_server_H100 = os.environ.get('HOSTNAME')
PC_NAME_server_4090 = os.environ.get('HOSTNAME')
...
if pc_name == PC_NAME_harry_local:
    ...
    dpath_data_raw = r'/root/autodl-tmp/b_data_train/data_a_raw'
    dpath_data_cache = r'/root/autodl-tmp/b_data_train/data_b_cache'
    dpath_data_cook = r'/root/autodl-tmp/b_data_train/data_c_cook'
else:
    # 如果有其他机器，在这里新增路径
    pass
